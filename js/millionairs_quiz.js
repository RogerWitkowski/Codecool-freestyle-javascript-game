...
function intro_millionairs() { // if you want to add text; Create a new var with your text; duplicate the function with your variables; set the fourth parameter to demo_3 etc
    ...
    let timer = setTimeout(function () {
        typeWriter(txt_2, i, speed, "demo_2")
    }, speed * txt_1.length + 200)
    // narrator.remove()
}
...
function change_text() {
    ...
    if (question.innerText == "") {
        ...
        correct = false
    } else if (question.innerText == questions[0]) {
        ...
        correct = false
    } else if (question.innerText == questions[3]) {
        ...
        correct = false
    } else if (question.innerText == questions[4]) {
        question.innerText = questions[5],
        ...
        correct = false
    } else if (question.innerText == questions[5]) {
        question.innerText = questions[6],
...
function check_correct() {
    if (question.innerText == questions[0] && answer4.checked) {
        correct = true
    } else if (question.innerText == questions[1] && answer3.checked) {
        correct = true
    } else if (question.innerText == questions[2] && answer1.checked) {
        correct = true
    } else if (question.innerText == questions[3] && answer2.checked) {
        correct = true
    } else if (question.innerText == questions[4] && answer1.checked) {
        correct = true
    } else if (question.innerText == questions[5] && answer4.checked) {
        correct = true
    } else if (question.innerText == questions[6] && answer2.checked) {
        correct = true
    } else {
        correct = false
    }
...
function check_answer() {
    if (correct == true && question.innerText == questions[6]) {
        alert('You\'re lucky, you\'re still alive. We will see how long it will be possible.'),
            setTimeout(function () {
                window.location.href = "killEmAll.html";
            },
                4000);
    }
    if (correct == true) {
        ...
        alert('Uuu wrong answer. Bye bye!.'),
            setTimeout(function () {
